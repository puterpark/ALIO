				...
				<div id="body">
					...
					<div>
						<div
							...
							<div style="padding: 18px 0; overflow: hidden;" class="big black bold">
								${LVL_VO.btitle} 
							</div>

							<div class="comment_name black">
								<b>${LVL_VO.mseq}</b>&nbsp;&nbsp;<font class='date'>${LVL_VO.regdate}</font><span class="darkgrey small"></span>
							</div>

							<form name="deleteform" action="/board" method="post" enctype="multipart/form-data">
							...
							<c:choose>
								<c:when test="${(LVL_SESS_MSEQ==LVL_VO.mseq && LVL_SESS_MGUBUN=='u')||LVL_SESS_MGUBUN=='a'}">
						...
						<div style="padding-bottom: 10px;" class="bold green upper">file download</div>
						<div>
						<a href="/board?action=down&fname=${LVL_VO.bfileName}">
							${LVL_VO.bfilePath}&#92;${LVL_VO.bfileName} (size:${LVL_VO.bfileSize}KB)
						</a>
						</div>
						...
						<div id="bottom"
							...
							<div style="width: 160px; float: left; padding-top: 10px; position: relative; visibility:hidden;"
								class="green bold">
							...
							<div style="width: 160px; float: left; padding-top: 10px;"
								class="green bold">
								<a onfocus="blur()" href='/board?action=list&type=${LVL_TYPE}' title='목록'><img
									src="/images/list.png"
